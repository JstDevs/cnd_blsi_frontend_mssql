        ...
        <div>
          ...
          <dl className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <dd className="text-sm text-neutral-900 col-span-2">{or.ResponsibilityCenterName || 'N/A'}</dd>
            </div>
            <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <dl className="space-y-2">
             <div className="grid grid-cols-3 gap-4">
                ...
                <dd className="text-sm text-neutral-900 col-span-2">{or.Payee || 'N/A'}</dd>
             </div>
             <div className="grid grid-cols-3 gap-4">
                <dt className="text-sm font-medium text-neutral-500">Payee Type</dt>
                <dd className="text-sm text-neutral-900 col-span-2">{or.PayeeType || 'N/A'}</dd>
             </div>
             <div className="grid grid-cols-3 gap-4">
                <dt className="text-sm font-medium text-neutral-500">Address</dt>
                <dd className="text-sm text-neutral-900 col-span-2">{or.Address || 'N/A'}</dd>
             </div>
          </dl>
        </div>
      </div>
              ...
              {(() => {
                ...
                if (items.length > 0) {
                  return items.map((item, index) => (
                    <tr key={index}>
                      <td className="px-6 py-4 text-sm text-neutral-900">{item.responsibilityCenterName || item.RC}</td>
